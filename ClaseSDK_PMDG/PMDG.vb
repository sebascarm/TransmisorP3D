...
Public Class PMDG
    ...
    Public Structure PMDG_NGX_Data
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public IRS_annunALIGN As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public IRS_annunON_DC As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public IRS_annunFAULT As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public IRS_annunDC_FAI As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public IRS_ModeSelector As Byte()    '0: OFF  1: ALIGN  2: NAV  3: ATT
        ...
        'Engine
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_EECSwitch As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_annunREVERSER As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_annunENGINE_CONTROL As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_annunALTN As Byte()
        ...
        'Forward overhead
        'Flight Controls
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FCTL_FltControl_Sw As Byte()  '0: STBY/RUD  1: OFF  2: ON
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FCTL_Spoiler_Sw As Byte()     'true: ON  false: OFF  
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FCTL_annunFC_LOW_PRESSURE As Byte()  'FLT CONTROL
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_PumpFwdSw As Byte()  'left fwd / right fwd
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_PumpAftSw As Byte()  'left aft / right aft
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_PumpCtrSw As Byte()  'ctr left / ctr right
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunENG_VALVE_CLOSED As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunSPAR_VALVE_CLOSED As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunFILTER_BYPASS As Byte()
        Public FUEL_annunXFEED_VALVE_OPEN As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunLOWPRESS_Fwd As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunLOWPRESS_Aft As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FUEL_annunLOWPRESS_Ctr As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_annunDRIVE As Byte()
        Public ELEC_annunSTANDBY_POWER_OFF As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_IDGDisconnectSw As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_GenSw As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_APUGenSw As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_annunTRANSFER_BUS_OFF As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_annunSOURCE_OFF As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ELEC_annunGEN_BUS_OFF As Byte()
        ...
        'Anti-ice
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Public ICE_annunOVERHEAT As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Public ICE_annunON As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Public ICE_WindowHeatSw As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ICE_TestProbeHeatSw As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ICE_annunVALVE_OPEN As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ICE_annunCOWL_ANTI_ICE As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ICE_annunCOWL_VALVE_OPEN As Byte()
        Public ICE_WingAntiIceSw As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ICE_EngAntiIceSw As Byte()

        'Hydraulics
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public HYD_annunLOW_PRESS_eng As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public HYD_annunLOW_PRESS_elec As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public HYD_annunOVERHEAT_elec As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public HYD_PumpSw_eng As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public HYD_PumpSw_elec As Byte()

        'Air systems
        Public AIR_TempSourceSelector As Byte               'Positions 0..6
        Public AIR_TrimAirSwitch As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public AIR_annunZoneTemp As Byte()
        Public AIR_annunDualBleed As Byte
        Public AIR_annunRamDoorL As Byte
        Public AIR_annunRamDoorR As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_RecircFanSwitch As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_PackSwitch As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_BleedAirSwitch As Byte()
        Public AIR_APUBleedAirSwitch As Byte
        Public AIR_IsolationValveSwitch As Byte
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_annunPackTripOff As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_annunWingBodyOverheat As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_annunBleedTripOff As Byte()
        ...
        'Bottom overhead
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_LandingLtRetractableSw As Byte()  '0: RETRACT  1: EXTEND  2: ON
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_LandingLtFixedSw As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_RunwayTurnoffSw As Byte()
        Public LTS_TaxiSw As Byte
        Public APU_Selector As Byte               '0: OFF  1: ON  2: START
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_StartSelector As Byte()           '0: GRD  1: OFF  2: CONT  3: FLT       
        ...
        'Glareshield
        'Warnings
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public WARN_annunFIRE_WARN As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public WARN_annunMASTER_CAUTION As Byte()
        ...
        'EFIS control panels
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_MinsSelBARO As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_BaroSelHPA As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_VORADFSel1 As Byte()         '0: VOR  1: OFF  2: ADF
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_VORADFSel2 As Byte()         '0: VOR  1: OFF  2: ADF 
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_ModeSel As Byte()            '0: APP  1: VOR  2: MAP  3: PLAn
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public EFIS_RangeSel As Byte()           '0: 5 ... 7: 640
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MCP_FDSw As Byte()
        Public MCP_ATArmSw As Byte
        Public MCP_BankLimitSel As Byte                 '0: 10 ... 4: 3
        Public MCP_DisengageBar As Byte

        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MCP_annunFD As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_annunBELOW_GS As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_MainPanelDUSel As Byte() '0: OUTBD PFD ... 4 MFD for Capt; reverse sequence for FO
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_LowerDUSel As Byte() '0: ENG PRI ... 2 ND for Capt; reverse sequence for FO
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_annunAP As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_annunAT As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_annunFMC As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_DisengageTestSelector As Byte()  '0: 1  1: OFF  2: 2
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public MAIN_TEFlapsNeedle As Single()   'Value
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public MAIN_annunGEAR_transit As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public MAIN_annunGEAR_locked As Byte()
        ...
        'Lower forward panel
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_MainPanelKnob As Byte()  'Position 0...150
        Public LTS_BackgroundKnob As Byte               ' Position 0...150
        Public LTS_AFDSFloodKnob As Byte                ' Position 0...150
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_OutbdDUBrtKnob As Byte()  'Position 0...127
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_InbdDUBrtKnob As Byte()  'Position 0...127   
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public LTS_InbdDUMapBrtKnob As Byte()  'Position 0...127
        ...
        'Control Stand
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_annunEXEC As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_annunCALL As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_annunFAIL As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_annunMSG As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_annunOFST As Byte()
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CDU_BrtKnob As Byte()    'Position 0...127
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FIRE_OvhtDetSw As Byte() '0: A  1: NORMAL  2: B
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FIRE_annunENG_OVERHEAT As Byte()
        Public FIRE_DetTestSw As Byte                   '0: FAULT/INOP  1: neutral  2: OVHT/FIRE
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public FIRE_HandlePos As Byte() '0: In  1: Blocked  2: Out  3: Turned Left  4: Turned right
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public FIRE_HandleIlluminated As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public FIRE_annunBOTTLE_DISCHARGE As Byte()
        Public FIRE_ExtinguisherTestSw As Byte          ' 0: 1  1: neutral  2: 2
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public FIRE_annunExtinguisherTest As Byte()   'Left, Right, APU

        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CARGO_annunExtTest As Byte()           'Fwd, Aft
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CARGO_DetSelect As Byte()              '0: A  1: ORM  2: B
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public CARGO_ArmedSw As Byte()
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public ENG_StartValve As Byte()    'true: valve open
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Public AIR_DuctPress As Single()   'PSI
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Public COMM_SelectedMic As Byte()  'array: 0=capt, 1=F/O, 2=observer.
        ...
        Public GPWS_V1CallEnabled As Byte        ' GPWS V1 callout option enabled
        ...
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9)> Public FMC_flightNumber As Byte()

        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=168)> Public reserved As Byte()
    ...
    Public Const UMOUSE_FLAG_WHEEL_SKIP As UInt32 = &H8000      'look at next 2 rect for mouse wheel commands 
    ...
    Public Enum PMDGEvents As UInteger
        ...
        EVT_OH_EFIS_HDG_REF_TOGGLE = (THIRD_PARTY_EVENT_ID_MIN + 6920)  ' 692A - Heading Reference Switch Toggle - note: ...
